    ...
    switch (data.effect) {
      ...
      transform = function(tr, c, x, a) {
        ...
        if (turnData.opts.gradients) {
          ...
          cssB['box-shadow'] = '0 0 0px rgba(0,0,0,0)';
          folding.css(cssB);
      ...
      if (data.corner) {
        ...
        if (point) {
          ...
          if ((data.effect=='sheet' && point.corner.length==2)  || data.effect=='hard') {
            ...
            point.x = origin.x;
            point.y = origin.y;
            /*Adding this condition to know if its a sheet then i can make the effect, NOT for hard*/
            if(data.effect == "sheet"){
