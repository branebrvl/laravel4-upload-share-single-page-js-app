...
(function(vanilla, undefined) {
  ...
  var config = {
    // unique campaign indentifier [13-5420] TH-AUS Christmas - Freedom Furniture (1) FlipBook Overlay
...
(function(vanilla, undefined) {
  ...
  VanillaApp.prototype.init = function(delay) {
    ...
    $('main').append(preloader.$el);
    preloader.render();

    // For testing only: delay removing of the preloader
    _.delay(function() {
      self.assetsLoader.initialLoad(app).done(function() {
        preloader.$el.remove();
        $('main').append(self.$el);
        self.render();
      });
...
(function(vanilla, undefined) {
  ...
  $(function() {
    ...
    // set delay to show prelodeer when testing
    vanillaApp.init(0);
  });
